...
#endif    // defined(ARDUINO) && !defined(CORE_RTL8722DM)
...
#if defined(BOARD_AMB23)    // Using onboard microphone
    Codec.setADCGain(0x2F, 0x2F);
#else    // Using external PDM microphone
    Codec.setInputMicType(PDMMIC);
    Codec.setDMicBoost(2, 2);
#endif
    Codec.setSampleRate(kAudioSampleFrequency);
    Codec.setReadCallback(CaptureSamples);

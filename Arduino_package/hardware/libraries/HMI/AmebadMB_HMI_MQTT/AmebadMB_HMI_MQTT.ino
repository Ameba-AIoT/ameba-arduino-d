...
//
#include "src/WiFi.h"
char *ssid = "louisguan"; // your wifi ssid Tenda_387CD0
char *password = "0989839679"; // your wifi password
// char* = char[] in array
WiFiClient AmebadClient;
//
//
#include "src/PubSubClient.h"
char* mqttServer = "192.168.0.104"; // mqtt server address
int mqttPort = 1883; // mqtt port
char* mqttUser = "MQTTSSID"; // your mqtt user
char* mqttPassword = "louis5897"; // your mqtt password
//

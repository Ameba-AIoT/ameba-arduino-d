...
#ifndef _BT_FUZZ_TEST_SIMPLE_BLE_SERVICE_H_
#define _BT_FUZZ_TEST_SIMPLE_BLE_SERVICE_H_
...
/** @defgroup SIMP_Service_Read_Info SIMP Service Read Info
  ...
  * @{
  */
#define BT_FUZZ_TEST_SIMP_READ_V1                                        1
/** @} */
...
/** @defgroup SIMP_Service_Write_Info SIMP Service Write Info
  ...
  * @{
  */
#define BT_FUZZ_TEST_SIMP_WRITE_V2                                       1
...
/** @defgroup SIMP_Service_Notify_Indicate_Info SIMP Service Notify Indicate Info
  ...
  * @{
  */
#define BT_FUZZ_TEST_SIMP_NOTIFY_INDICATE_V3_ENABLE     1
#define BT_FUZZ_TEST_SIMP_NOTIFY_INDICATE_V3_DISABLE    2
#define BT_FUZZ_TEST_SIMP_NOTIFY_INDICATE_V4_ENABLE     3
#define BT_FUZZ_TEST_SIMP_NOTIFY_INDICATE_V4_DISABLE    4


/** @} */

#define BT_FUZZ_TEST_SIMP_READ_V1_MAX_LEN               300
...
/**
  ...
  *
  */
T_SERVER_ID bt_fuzz_test_simp_ble_service_add_service(void *p_func);
...
/**
  ...
  * @retval 1 true
  */
bool bt_fuzz_test_simp_ble_service_set_parameter(T_SIMP_PARAM_TYPE param_type, uint16_t len, void *p_value);
...
/**
  ...
  * @retval 0 false
  */
bool bt_fuzz_test_simp_ble_service_send_v3_notify(uint8_t conn_id, T_SERVER_ID service_id,
...
/**
  ...
  * @retval 0 false
  */
bool bt_fuzz_test_simp_ble_service_send_v4_indicate(uint8_t conn_id, T_SERVER_ID service_id,
                                       void *p_value, uint16_t length);
...
#endif /* _BT_FUZZ_TEST_SIMPLE_BLE_SERVICE_H_ */

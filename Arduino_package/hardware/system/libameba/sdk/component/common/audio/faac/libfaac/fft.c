...
void fft_initialize( FFT_Tables *fft_tables )
{
	...
	//fft_tables->costbl		= pvPortMalloc( (MAXLOGM+1) * sizeof( fft_tables->costbl[0] ) );
	//fft_tables->negsintbl	= pvPortMalloc( (MAXLOGM+1) * sizeof( fft_tables->negsintbl[0] ) );
	//fft_tables->reordertbl	= pvPortMalloc( (MAXLOGM+1) * sizeof( fft_tables->reordertbl[0] ) );

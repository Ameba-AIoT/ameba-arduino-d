...
#define MESH_GATT_CLIENT_SUPPORT                1 //!< gatt client support
...
#define MESH_SCHED_ADV_PKT_NUM                  10 //!< The number of stored mesh advertise packets

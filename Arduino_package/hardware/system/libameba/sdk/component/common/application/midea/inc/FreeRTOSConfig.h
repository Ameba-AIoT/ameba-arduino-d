...
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 75 * 1024 ) )//( ( size_t ) ( 70 * 1024 ) )
...
#define configTIMER_TASK_STACK_DEPTH    ( 2048 )     // 512*4=2K
...
/* In wlan usage, this value is suggested to use value less than 100 milliseconds */

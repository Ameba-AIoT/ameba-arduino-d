...
#include "boot_rom_homekit_ed25519_fe.h"
...
#endif
void boot_rom_ed25519_ge_tobytes(unsigned char *,const ge_p2 *);
int boot_rom_ed25519_ge_frombytes_negate_vartime(ge_p3 *,const unsigned char *);
void boot_rom_ed25519_ge_double_scalarmult_vartime(ge_p2 *,const unsigned char *,const ge_p3 *,const unsigned char *);

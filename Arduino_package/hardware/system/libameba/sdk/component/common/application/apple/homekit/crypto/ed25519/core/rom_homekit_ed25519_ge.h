#ifndef ROM_HOMEKIT_ED25519_GE_H
#define ROM_HOMEKIT_ED25519_GE_H
...
#include "rom_homekit_ed25519_fe.h"
...
#endif
void rom_ed25519_ge_tobytes(unsigned char *,const ge_p2 *);
void rom_ed25519_ge_p3_tobytes(unsigned char *,const ge_p3 *);
int rom_ed25519_ge_frombytes_negate_vartime(ge_p3 *,const unsigned char *);
void rom_ed25519_ge_scalarmult_base(ge_p3 *,const unsigned char *);
void rom_ed25519_ge_double_scalarmult_vartime(ge_p2 *,const unsigned char *,const ge_p3 *,const unsigned char *);

#endif /* ROM_HOMEKIT_ED25519_GE_H */

 ...
 *
 ******************************************************************************/
#ifndef __RTL8721D_XMIT_H__
#define __RTL8721D_XMIT_H__
...
void rtl8721d_update_txdesc(struct xmit_frame *pxmitframe, u8 *pmem);
void rtl8721d_fill_fake_txdesc(PADAPTER padapter, u8 *pDesc, u32 BufferLen, u8 IsPsPoll, u8 IsBTQosNull, u8 bDataFrame);

s32 rtl8721dd_init_xmit_priv(PADAPTER padapter);
void rtl8721dd_free_xmit_priv(PADAPTER padapter);
s32	rtl8721dd_hal_xmit(_adapter *padapter, struct xmit_frame *pxmitframe);
s32 rtl8721dd_mgnt_xmit(_adapter *padapter, struct xmit_frame *pmgntframe);
s32	rtl8721dd_hal_xmitframe_enqueue(_adapter *padapter, struct xmit_frame *pxmitframe);
void rtl8721dd_xmitframe_resume(_adapter *padapter);
u32 GetDmaTxbdIdx(u32 ff_hwaddr);
struct xmit_buf * rtl8721d_dequeue_xmitbuf(struct rtw_tx_ring	*ring);

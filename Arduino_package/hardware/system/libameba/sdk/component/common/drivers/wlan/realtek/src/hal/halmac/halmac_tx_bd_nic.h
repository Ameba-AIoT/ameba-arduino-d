...
#define SET_TX_BD_A1(txbd, value)                                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x08, 31, 1, value)
#define GET_TX_BD_A1(txbd) LE_BITS_TO_4BYTE(txbd + 0x08, 31, 1)
#define SET_TX_BD_TX_BUFF_SIZE1(txbd, value)                                   \
	SET_BITS_TO_LE_4BYTE(txbd + 0x08, 0, 16, value)
#define GET_TX_BD_TX_BUFF_SIZE1(txbd) LE_BITS_TO_4BYTE(txbd + 0x08, 0, 16)

/*TXBD_DW3*/

#define SET_TX_BD_PHYSICAL_ADDR1_LOW(txbd, value)                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x0C, 0, 32, value)
#define GET_TX_BD_PHYSICAL_ADDR1_LOW(txbd) LE_BITS_TO_4BYTE(txbd + 0x0C, 0, 32)

/*TXBD_DW4*/

#define SET_TX_BD_A2(txbd, value)                                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x10, 31, 1, value)
#define GET_TX_BD_A2(txbd) LE_BITS_TO_4BYTE(txbd + 0x10, 31, 1)
#define SET_TX_BD_TX_BUFF_SIZE2(txbd, value)                                   \
	SET_BITS_TO_LE_4BYTE(txbd + 0x10, 0, 16, value)
#define GET_TX_BD_TX_BUFF_SIZE2(txbd) LE_BITS_TO_4BYTE(txbd + 0x10, 0, 16)

/*TXBD_DW5*/

#define SET_TX_BD_PHYSICAL_ADDR2_LOW(txbd, value)                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x14, 0, 32, value)
#define GET_TX_BD_PHYSICAL_ADDR2_LOW(txbd) LE_BITS_TO_4BYTE(txbd + 0x14, 0, 32)

/*TXBD_DW6*/

#define SET_TX_BD_A3(txbd, value)                                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x18, 31, 1, value)
#define GET_TX_BD_A3(txbd) LE_BITS_TO_4BYTE(txbd + 0x18, 31, 1)
#define SET_TX_BD_TX_BUFF_SIZE3(txbd, value)                                   \
	SET_BITS_TO_LE_4BYTE(txbd + 0x18, 0, 16, value)
#define GET_TX_BD_TX_BUFF_SIZE3(txbd) LE_BITS_TO_4BYTE(txbd + 0x18, 0, 16)

/*TXBD_DW7*/

#define SET_TX_BD_PHYSICAL_ADDR3_LOW(txbd, value)                              \
	SET_BITS_TO_LE_4BYTE(txbd + 0x1C, 0, 32, value)
#define GET_TX_BD_PHYSICAL_ADDR3_LOW(txbd) LE_BITS_TO_4BYTE(txbd + 0x1C, 0, 32)

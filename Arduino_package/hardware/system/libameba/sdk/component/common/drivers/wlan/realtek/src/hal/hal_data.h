...
#if !defined(CONFIG_RTL8723D) && !defined(CONFIG_RTL8821C)
...
#if defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8192E) || defined(CONFIG_RTL8195B) || defined(CONFIG_RTL8721D) || defined(CONFIG_RTL8710C)
	u8  u1ForcedIgiLb;
	u8	PAType_2G;
	u8	LNAType_2G;
	u8	external_pa_2g;
...
#if (defined(CONFIG_RTL8711B) || defined(CONFIG_RTL8188F) || defined(CONFIG_RTL8192E) ||defined (CONFIG_RTL8723D)|| defined(CONFIG_RTL8821C)) || defined(CONFIG_RTL8721D) || defined(CONFIG_RTL8195B) || defined(CONFIG_RTL8188E) || defined(CONFIG_RTL8710C)

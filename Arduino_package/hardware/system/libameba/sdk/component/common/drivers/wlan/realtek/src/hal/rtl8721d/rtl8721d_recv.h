 ...
 *
 ******************************************************************************/
#ifndef __RTL8721D_RECV_H__
#define __RTL8721D_RECV_H__

#ifdef CONFIG_WLAN_HAL_TEST
#define MAX_RECVBUF_SZ	1500//(RX_DMA_SIZE_8721D - RX_DMA_RESERVED_SIZE_8721D)
#else
#if (SKB_PRE_ALLOCATE_RX==1)
#define MAX_RECVBUF_SZ	MAX_SKB_BUF_SIZE //1650 //(RX_DMA_SIZE_8721D - RX_DMA_RESERVED_SIZE_8721D)
#else
...
s32 rtl8721d_init_recv_priv(PADAPTER padapter);
void rtl8721d_free_recv_priv(PADAPTER padapter);
void rtl8721d_query_rx_desc_status(union recv_frame *precvframe, u8 *pdesc);
void rtl8721d_query_rx_phy_status(union recv_frame	*precvframe, u8 *pphy_status);

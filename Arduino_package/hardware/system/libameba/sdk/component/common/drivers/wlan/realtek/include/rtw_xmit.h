...
#if defined(CONFIG_AXI_HCI) && !defined(CONFIG_PLATFORM_8710C)
...
#if  defined(CONFIG_RTL8812A) || defined(CONFIG_RTL8821A)|| defined(CONFIG_RTL8723B) || defined(CONFIG_RTL8195A) || defined(CONFIG_RTL8711B) \
	|| defined(CONFIG_RTL8188F) || defined(CONFIG_RTL8192E) || defined(CONFIG_RTL8721D) \
	|| defined(CONFIG_RTL8710C) || defined(CONFIG_RTL8723D)
#define TXDESC_SIZE 40
#elif defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8195B)
...
struct tx_desc{
    ...
    unsigned int txdw9;
#endif
#if defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8195B)
	unsigned int txdw10;	
...
struct rtw_tx_ring {
#if ((RTL8195A_SUPPORT ==1) ||(RTL8711B_SUPPORT == 1) || (RTL8721D_SUPPORT == 1) || (RTL8195B_SUPPORT == 1) || (RTL8710C_SUPPORT == 1))

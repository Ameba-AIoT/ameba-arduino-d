...
enum btc_wl2bt_scoreboard {
	BTC_SCBD_ACTIVE		= BIT(8),
	BTC_SCBD_ONOFF		= BIT(9),
	BTC_SCBD_SCAN		= BIT(10),
	BTC_SCBD_UNDERTEST	= BIT(11),
	BTC_SCBD_RXGAIN		= BIT(12),
	BTC_SCBD_WLBUSY		= BIT(13),
	BTC_SCBD_EXTFEM		= BIT(14),//8721D need ?
	BTC_SCBD_FIX2M		= BIT(14) //8721D need ?
};
enum btc_bt2wl_scoreboard {
	BTC_SCBD_BT_ONOFF	= BIT(9),
	BTC_SCBD_BT_LPS		= BIT(10)
};
#else
enum btc_wl2bt_scoreboard {
...
enum btc_gnt_setup_state {
	BTC_GNT_SET_TO_LOW	= 0x0,
	BTC_GNT_SET_TO_HIGH	= 0x1,
	BTC_GNT_SET_BY_HW	= 0x2,
	BTC_GNT_SET_MAX
};
...
//==================================
// This is for linux coding style revise
//==================================
...
//devin add refer to CoexVer WL 20170509_19
struct completion {	
	unsigned int done;
...
enum btc_bt_state_cnt {
	...
	BTC_CNT_BT_REENABLE	= 0x2,
	BTC_CNT_BT_POPEVENT	= 0x3,
	BTC_CNT_BT_SETUPLINK	= 0x4,
	BTC_CNT_BT_IGNWLANACT	= 0x5,
	BTC_CNT_BT_INQ		= 0x6,
	BTC_CNT_BT_PAGE		= 0x7,
	BTC_CNT_BT_ROLESWITCH	= 0x8,
	BTC_CNT_BT_AFHUPDATE	= 0x9,
	BTC_CNT_BT_RELINK	= 0xa,
	BTC_CNT_BT_DISABLE	= 0xb,
	BTC_CNT_BT_INFOUPDATE	= 0xc,
	BTC_CNT_BT_MAX
};

enum btc_wl_state_cnt {
	BTC_CNT_WL_SCANAP		= 0x0,
	BTC_CNT_WL_CONNPKT		= 0x1,
	BTC_CNT_WL_SPECPKT		= 0x2,
	BTC_CNT_WL_ARP			= 0x3,
	BTC_CNT_WL_GNTERR		= 0x4,
	BTC_CNT_WL_PSFAIL		= 0x5,
	BTC_CNT_WL_COEXRUN		= 0x6,
	BTC_CNT_WL_PNPWAKEUP		= 0x7,
	BTC_CNT_WL_COEXINFO1		= 0x8,
	BTC_CNT_WL_COEXINFO2		= 0x9,
	BTC_CNT_WL_AUTOSLOT_HANG	= 0xa,
	BTC_CNT_WL_NOISY0		= 0xb,
	BTC_CNT_WL_NOISY1		= 0xc,
	BTC_CNT_WL_NOISY2		= 0xd,
	BTC_CNT_WL_CCKLOCK		= 0xe,
	BTC_CNT_WL_STAYBUSY		= 0xf,
	BTC_CNT_WL_ACTIVEPORT		= 0x10,
	BTC_CNT_WL_MAX
};
...
struct btc_coex_sta {
	boolean coex_running;
	boolean coex_freeze;
	boolean corx_en;
	boolean tdma_bt_autoslot;
	boolean tdma_bt_autoslot_hang;
	...
	boolean bt_acl_busy;
	boolean bt_acl_busy_pre;
	boolean bt_fix_2M;
	boolean bt_setup_link;
	boolean bt_setup_link_pre;
	boolean bt_multi_link;
	boolean bt_a2dp_sink;
	boolean bt_reenable;
	boolean bt_ble_scan_en;
	boolean bt_hid_lo_pri_tx_overhead;
	boolean bt_hid_lo_pri_tx_overhead_pre;
	boolean bt_esco_mode;
	boolean bt_slave;
...
VOID
EXhalbtcoutsrc_TxRatChangeNotify(
	IN PBTC_COEXIST		pBtCoexist,
	IN u1Byte			tx_rate,
	IN u1Byte			tx_retry_ratio,
	IN u1Byte			macid
	);
VOID

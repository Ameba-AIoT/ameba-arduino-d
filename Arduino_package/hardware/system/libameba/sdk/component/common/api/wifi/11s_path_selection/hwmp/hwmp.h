...
#define UPDATE_MESH_METRIC 0x8BAE					//update mesh metric//#define REMOVE_PATH_ENTRY_NEIGHBOR_DISPEAR  0x8B83	// remove invalide path entry form path selection table

...
PinDescription g_APinDescription[TOTAL_GPIO_PIN_NUM]=
{
    ...
    {PB_3,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ             , MODE_NOT_INITIAL}, // AMB_D9
    ...
    {PB_4,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM   , MODE_NOT_INITIAL}, // AMB_D14
    {PB_5,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM   , MODE_NOT_INITIAL}, // AMB_D15
    {PB_6,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ             , MODE_NOT_INITIAL}, // AMB_D16
    {PB_7,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM   , MODE_NOT_INITIAL}, // AMB_D17
    {PB_1,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ             , MODE_NOT_INITIAL}, // AMB_D18
    {PB_2,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ             , MODE_NOT_INITIAL}, // AMB_D19
